            ...
            <tbody>
                ...
                ?>
                    <tr class="align-middle">
                        ...
                        <td>
                            <a href="?page=karyawantambah&nik=<?php echo $row["nik"] ?>" class="btn btn-primary">
                                <i class="fa fa-edit"></i> Ubah
                            </a>
                            <a href="?page=karyawanhapus&nik=<?php echo $row["nik"] ?>" onclick="javascript: return confirm('Konfirmasi data akan dihapus?')" class="btn btn-danger">
